      ...
      <div className="px-8 py-6 bg-[var(--background)] min-h-screen flex flex-col">
        ...
        <div className="mb-4">
          <h1 className="text-2xl font-bold text-slate-900 tracking-tight">
            <button
              type="button"
              onClick={() => router.push("/nghiep-vu-dao-tao/tu-van-hoc-tap")}
        ...
        <div className="flex-1 flex flex-col gap-4">
          {/* Student Info Card - sticky, nội dung mới */}
            ...
            <div className="grid grid-cols-2 gap-8">
              <div className="space-y-3">
                ...
                <div className="flex gap-4">
                  ...
                  <span className="text-base font-semibold text-gray-900">{student.gpa}</span>
                </div>
              </div>
              <div className="space-y-3">
                <div className="flex gap-4">
                  <span className="font-semibold text-blue-700 min-w-fit">TCBB:</span>
                  <span className="text-base font-semibold text-gray-900">112/120</span>
                </div>
                <div className="flex gap-4">
                  <span className="font-semibold text-blue-700 min-w-fit">TCTC:</span>
                  <span className="text-base font-semibold text-gray-900">30/34</span>
                </div>
                <div className="flex gap-4">
                  <span className="font-semibold text-blue-700 min-w-fit">TCBB thiếu:</span>
                  <span className="text-base font-semibold text-gray-900">8</span>
                </div>
                <div className="flex gap-4">
                  <span className="font-semibold text-blue-700 min-w-fit">TCTC thiếu:</span>
                  <span className="text-base font-semibold text-gray-900">4</span>
                </div>
              </div>
            </div>
          </div>
                ...
                <div className="border border-[var(--border)] rounded-lg overflow-hidden flex flex-col flex-1">
                  ...
                  <div className="mt-4 pt-4 border-t border-gray-200 sticky bottom-0 z-10 bg-white">
                    <div className="flex items-center justify-between px-6 py-3">
                      <div className="text-sm text-gray-600">Hiển thị 07/07 dòng</div>
