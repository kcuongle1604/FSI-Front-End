  ...
  useEffect(() => {
    if (regulation && open) {
      setFormData({
        ...
        batches: Array.isArray((regulation as any).batches) ? (regulation as any).batches : [],
        specializations: Array.isArray((regulation as any).specializations) ? (regulation as any).specializations : [],
      });
    }
  }, [regulation, open]);
