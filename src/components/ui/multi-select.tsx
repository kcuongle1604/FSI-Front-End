...
import { useInputDropdownPosition } from "@/hooks/use-dropdown-position"
...
export function MultiSelect({ 
  ...
  // Use custom hook for dropdown position
  const dropdownRect = useInputDropdownPosition(open, buttonRef)
  ...
  // No need for manual effect, handled by hook
